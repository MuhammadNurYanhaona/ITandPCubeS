...
/*	Classes in this header files are used to determine which index of a for loop iteration maps to what 
	array variables and their dimensions. A minimal scope management is needed for this process. Thus an 
	IndexScope class is defined along with the IndexArrayAssociation class.  
*/
