...
class TaskEnvStat {
  ...
  public:
	...
	// structures they individually access. To achieve that, we insert sync stages for LPSes at the end of 
	// the computation flow that read all stale data structures an LPS is interested in. We do this stage 
	// insertation before the data dependency analysis kicks in and draws the dependency arcs between stages.  
