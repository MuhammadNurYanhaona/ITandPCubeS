...
// and generates the initialization functions for those variables and structures too.
...
class SyncManager {
  ...
  public:
	...
	// this tells if the task under concern requires synchronization or not
	...
	// this function generates the method that the task::main function uses to initialze sync 
	// primitive arrays and each primitive inside those arrays
	...
	// beginning to get in SyncDataStructure described above with all pointer references set
